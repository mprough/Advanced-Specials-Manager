...
class AdvancedSpecialsManager
{
    ...
    public function preview(int $ruleId): array
    {
        ...
        foreach ($products as &$product) {
            $product['calculated_price'] = $this->calculatePrice($rule, (float)$product['products_price']);
    ...
    private function matchingProducts(array $rule): array
    {
        ...
        foreach (['price_min' => 'p.products_price >= ', 'price_max' => 'p.products_price <= ', 'stock_min' => 'p.products_quantity >= ', 'stock_max' => 'p.products_quantity <= '] as $field => $condition) {

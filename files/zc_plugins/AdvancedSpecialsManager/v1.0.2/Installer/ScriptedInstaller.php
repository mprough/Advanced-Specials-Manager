    ...
    protected function executeInstall(): bool
    {
        ...
        $this->executeInstallerSql(
            "INSERT IGNORE INTO " . TABLE_CONFIGURATION . "
             ...
             VALUES ('Installed version', 'PLUGIN_ADVANCED_SPECIALS_MANAGER_VERSION', '1.0.2', 'Installed Advanced Specials Manager version.', 0, 0, 'zen_cfg_select_option(array(\'1.0.2\'),')"
        );
        $this->executeInstallerSql(
            "UPDATE " . TABLE_CONFIGURATION . " SET configuration_value = '1.0.2', set_function = 'zen_cfg_select_option(array(\'1.0.2\'),' WHERE configuration_key = 'PLUGIN_ADVANCED_SPECIALS_MANAGER_VERSION'"
        );
